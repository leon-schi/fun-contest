...
\newcommand{\makeheader}[1]{%
  ...
  \begin{paracol}{3}
  \includegraphics[width=3cm]{.template/kit-logo.pdf}
  \switchcolumn
  \center
  {\Large\textbf{Competitive Programming SS21}}\\
  \vspace{2mm}
  \textbf{Submit until #1 via the \href{https://domjudge.iti.kit.edu/main/login}{judge}}
  \switchcolumn
  \hfill
  \includegraphics[width=3cm]{.template/hpi-logo.pdf}\\
  \end{paracol}
